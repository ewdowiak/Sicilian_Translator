...
The [`main.py`](main.py) script in this directory is a hack-a-doodle rewrite of [Sockeye](https://awslabs.github.io/sockeye/)'s `translate.py` for web translation with [FastAPI](https://fastapi.tiangolo.com/).
