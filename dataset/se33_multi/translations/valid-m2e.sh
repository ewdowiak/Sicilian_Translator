...
##  input files
INFILES=(
  "./validation/m2e_valid_v2-sbw_p02-scen.src"
  "./validation/m2e_valid_v2-sbw_p03-iten.src"
)
##  score file
SCORES="./bleu-chrf_m2e-c01.txt"
...
for (( IDX = 0; IDX < ${#INFILES[@]}; IDX++ )) ; do
    ...
    ##  translate
    ${SOCKEYE} --models ${TNF_SCEN} --input ${INFILE} --output ${OTFILE} --output-type ${OUTPUT_TYPE} --quiet
