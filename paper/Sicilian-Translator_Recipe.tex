...
%% We may use this method in the future.  So far we have not because (in our case) assembling
%% Sicilian monolingual text would require almost as much time as assembling parallel text.
%% But in the end, we'll have some leftover unmatched text, which we can use for back-translation.

%% ... automatically translate the unmatched Sicilian text ...
